...
// registerCommon configures the field indices required by both the
...
func RegisterCommon(ctx context.Context, idx client.FieldIndexer, log *zap.SugaredLogger) error {
	if idx == nil {
